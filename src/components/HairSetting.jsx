...
const HairSetting = () => {
  ...
  return (
    <div className="p-8 bg-white rounded-xl shadow-md max-w-[1200px] mx-auto  dark:bg-slate-900 dark:text-white">
      <h2 className="text-3xl font-semibold text-blue-900 mb-2  dark:bg-slate-900 dark:text-white">Hair Setting</h2>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {hairSettings.map(style => (
          ...
          >
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold text-blue-900  dark:bg-slate-900 dark:text-white">{style.title}</h3>
              <p className="text-gray-600 text-sm mt-1  dark:bg-slate-900 dark:text-white">{style.description}</p>
      ...
      {selectedStyle && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 ">
          <div className="bg-white p-6 rounded-xl shadow-lg max-w-md w-full relative  dark:bg-slate-900 dark:text-white">
            ...
            <img src={selectedStyle.image} className="w-full h-48 object-cover rounded-lg mb-4  dark:bg-slate-900 dark:text-white" alt={selectedStyle.title} />
            <h3 className="text-xl font-bold text-blue-800  dark:bg-slate-900 dark:text-white">{selectedStyle.title}</h3>
            <p className="text-gray-700 my-2  dark:bg-slate-900 dark:text-white">{selectedStyle.description}</p>
